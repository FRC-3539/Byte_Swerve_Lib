 ...
 * Academy video</a>.
 */
public class CentripetalRadiusAccelerationConstraint extends TrajectoryConstraint {
    private final double maxCentripetalAcceleration;

    /**
     * @param maxCentripetalAcceleration the maximum centripetal acceleration
     */
    public CentripetalRadiusAccelerationConstraint(double maxCentripetalAcceleration) {
